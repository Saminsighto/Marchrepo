...
<p style="margin-top: 8px;">Go to the bottom-left corner of your Insighto dashboard where your name or email appears.Click it to open the settings menu, then select System Logs.Here, you'll find detailed logs and error messages to help identify any issues with your assistant.</p>
</details> 

 <details style="border-bottom: 1px solid #e5e7eb; padding: 16px;">
<summary>Ensure Twilio account is upgraded</summary>
<p style="margin-top: 8px;">Free trial accounts may block live calls</p>
</details> 

 <details style="border-bottom: 1px solid #e5e7eb; padding: 16px;">
<summary>Confirm voice routing is set to US1</summary>
<p style="margin-top: 8px;">Confirm voice routing is set to US1 in your Twilio phone number settings</p>
</details> 

 <details style="border-bottom: 1px solid #e5e7eb; padding: 16px;">
<summary>Verify Auth Token & SID</summary>
<p style="margin-top: 8px;">Verify Auth Token & SID used in Insighto are correct</p>
</details> 
