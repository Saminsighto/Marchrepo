...
If your voice assistant isn’t working as expected, here are a few ways to identify the issue:
 ...
 <details><summary>Check the Logs Tab</summary><p>Go to the bottom-left corner of your Insighto dashboard where your name or email appears.Click it to open the settings menu, then select System Logs.Here, you'll find detailed logs and error messages to help identify any issues with your assistant.</p></details> 

 <details><summary>Ensure Twilio account is upgraded</summary><p>Free trial accounts may block live calls</p></details> 

 <details><summary>Confirm voice routing is set to US1</summary><p>Confirm voice routing is set to US1 in your Twilio phone number settings</p></details> 

 <details> <summary>Verify Auth Token & SID</summary><p>Verify Auth Token & SID used in Insighto are correct</p></details> 

 <details><summary>Check call recordings and call status</summary><p>Check call recordings and call status in your Twilio console</p></details> 
