...
This enables you to purchase credits from Insighto at standard rates ([Article here](https://docs.insighto.ai/Insighto-Billing-Pay-As-You-Go)), calculate your own markup, and offer them as part of your pricing plans.

💳 **Don’t Want to Use wallet/Purchase Credits from Us?**

If you prefer to use your own API keys and bypass purchasing credits from Insighto, follow this [BYOK guide](https://docs.insighto.ai/BYOK) to set up your API keys.
...
Follow the steps mentioned [here](https://docs.stripe.com/keys) to generate your secret key.
