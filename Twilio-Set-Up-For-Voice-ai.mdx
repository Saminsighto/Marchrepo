...
If your voice assistant isn’t working as expected, refer to the following checks:

| Issue                         | What to Do                                                                 |
|------------------------------|-----------------------------------------------------------------------------|
| System Logs                  | Go to the bottom-left of your Insighto dashboard → click your name → select System Logs to view error messages. |
| Twilio Account Not Upgraded  | Ensure your Twilio account is upgraded; trial accounts may block live calls. |
| Voice Routing Region         | Confirm that your Twilio number's Voice routing is set to US1.             |
