...
Click on Widgets from the Left Panel
...
Select Twilio as the Provider Type and Click Next
...
Select Widget Type, Name, and Describe Your Widget
...
Select Your Chat Assistant from the Dropdown
