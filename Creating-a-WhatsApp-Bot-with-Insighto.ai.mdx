---
title: "🚀 Creating a WhatsApp Bot with Insighto.ai"
---
...
4. Create a new **App** (choose _Business_ as the type).
...
4. Enter your WhatsApp number and the credentials collected from Step 1
5. Click **Submit**
