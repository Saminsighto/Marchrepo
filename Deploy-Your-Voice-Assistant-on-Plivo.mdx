# Deploy your Voice Assistant on Plivo
...
- Ensure Plivo account is upgraded — Free trial accounts may block live calls  
- Verify Auth Token & ID used in Insighto are correct  
- Check call recordings and call status in your Plivo console
